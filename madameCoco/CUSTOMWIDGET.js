var obj = JSON.parse(document.querySelectorAll(".analytics-data")[1].innerText);
if (obj.productList.data.products.length < 10) {
    var cat = obj.productList.data.products[0].main_category;
    var vl = new Visilabs();
    vl.AddParameter("json", true);
    vl.AddParameter("cat", cat);
    vl.Suggest(23, null, null, CallBackMethod);
...
function CallBackMethod(dataArr) {
    if (dataArr.length > 0) {
        ...
        var pos = document.querySelector(".col-sm-10.list-content-parent");

        var style = document.createElement("style");
        style.innerHTML = ` 
        .noface-section__heading{    position: relative;
            color: #000;
            text-align: center;
            margin-bottom: 20px;
        }
        
        .noface-section__heading:before{
            position: absolute;
            content: "";
            top: 50%;
            left: 0;
    ...
    display: -webkit-box;
        ...
        @media only screen and (max-width: 767px) {
            .homepage .noface-section__heading__text {
                font-size: 17px;
                padding: 0;
            }

            .homepage .noface-section__heading {
                margin-bottom: 10px;
            }
    ...
    .vl-discounted { display: none; }
        ...
        wrapper.innerHTML = '<div class="vl-widget" id="vl-cat-topsellers"><div class="noface-section__heading"><span class="noface-section__heading__text">İlginizi Çekebilecek Ürünler</span></div><div class="vl-slider"><div class="vl-slider-wrapper">' + html + '</div></div></div>';
        ...
        $('#vl-cat-topsellers .vl-slider-wrapper').slick({
            dots: true,
            infinite: false,
            speed: 300,
            slidesToShow: 3,
        ...
        var identifier = "vl-cat-topsellers";
        ...
        for (var i = 0; i < Elemimage.length; i++) {
            ...
            document.querySelectorAll(".vl-product-img")[i].src = s.split(".jpg")[0] + '_size264x200_cropCenter.jpg';
        }
        ...
        if (wrapper) {
            ...
            var indirim = wrapper.querySelectorAll(".vl-discounted");
