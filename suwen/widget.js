...
var identifier="vl-home-lastviews";vlWidgetHandler(identifier,{axis:"X",itemsToView:4,arrows:{size:18,borderSize:6.25,color:"#31363a",mobile:!0},autoScroll:!0,autoScrollTimer:7,responsive:[{breakpoint:1024,settings:{itemsToView:2}}]});var wrapper=document.getElementById(identifier);if(wrapper){var productPrice=wrapper.querySelectorAll(".vl-price");var dPrice=wrapper.querySelectorAll(".vl-dprice");var item=wrapper.querySelectorAll(".vl-slider-item");var imgEls=wrapper.querySelectorAll(".vl-product-img");for(var i=0;i<productPrice.length;i++){if(dPrice[i].innerText==productPrice[i].innerText){productPrice[i].innerHTML="<br />";productPrice[i].style.textDecoration="none";dPrice[i].style.color='#000'}}
for(i=0;i<item.length;i++){if(dPrice[i].innerText.indexOf(".")){dPrice[i].innerText=dPrice[i].innerText.replace(".",",")}
if(productPrice[i].innerText.indexOf(".")){productPrice[i].innerText=productPrice[i].innerText.replace(".",",")}}}
...
<div class="vl-widget" id="vl-home-topsellers">
  <div class="noface-section__heading">
    <span class="noface-section__heading__text">Popüler Ürünler</span>
  </div>
    <div class="vl-slider">
