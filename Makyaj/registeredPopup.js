function CallPopup() {
    ...
    img.src = "https://img.visilabs.net/banner/uploaded_images/244_1239_20200703160848178.jpg";
...
var _interval = setInterval(function () {
    try {
        if(document.querySelector(".successfull-signup-root.open")){
            CallPopup();
