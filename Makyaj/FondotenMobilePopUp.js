function showLightBox(height,width){
    ...
    link.href="https://www.nyxcosmetics.com.tr/total-control-drop-foundation?utm_source=makyajcom&utm_medium=popup&utm_campaign=makyajcomoneriyor&OM.zn=acttype-4&OM.zpc=act-15";
link.setAttribute("target", "_blank");

    var img=document.createElement("img");
    img.setAttribute("id","visi_lightbox_image");
    img.src="https://img.visilabs.net/banner/uploaded_images/244_1243_20200313101404610.jpg";
...
popbox.querySelector("#visi_lightbox_image").addEventListener("click", function(){ <%VLSendClickFunc%>;});

}

<%VLSendImpressionFunc%>;
showLightBox("400px","300px");