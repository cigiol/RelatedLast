function topBannerMobile(){
    ...
    img.src="https://img.visilabs.net/banner/uploaded_images/244_1240_20200416103213245.jpg";
    ...
    function topBannerDesktop(){
        ...
        var img=document.createElement("img");
        img.setAttribute("id","visi_image");
        img.src="https://img.visilabs.net/banner/uploaded_images/244_1240_20200416103226921.jpg";
        ...
        var b = localStorage.getItem('topBanner');
    if(!b){
