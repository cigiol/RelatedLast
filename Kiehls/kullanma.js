function showLightBox(height,width){
    ...
    overlay_content.style.top="calc(100% - 78px)";
    ...
    if (/windows phone/i.test(userAgent)) {
		...
		link.href="https://play.google.com/store/apps/details?id=com.alegra.kiehls";
    }
	   ...
	   link.href="https://play.google.com/store/apps/details?id=com.alegra.kiehls";
		...
		overlay_content.style.transform = "translate3d(-50%, -50%,3px)";
		var link=document.createElement("a");
		link.href="https://apps.apple.com/tr/app/kiehls-t%C3%BCrkiye/id1387874213";
    }
    else{
	console.log("unknown");}
    ...
    img.src="https://img.visilabs.net/banner/uploaded_images/244_1240_20200320111318429.jpg";
