...
function topBannerMobile(){
    ...
    img.src="https://img.visilabs.net/banner/uploaded_images/244_1240_20200611144114256.jpg";
    img.style.height="auto";
    img.style.width="100%";

    visi.appendChild(img);
    ...
    var countDownDate = new Date("Jun 13 2020, 20:00:00");
    ...
    function topBannerDesktop(){
        ...
        var style='<style>\#vl_timer{background-color: black;color: white;display: block;width: auto;height: 54px;font-size: 38px;position: absolute;bottom: calc(50% - 26px);right: 6%;}\
        .vl-time-area{float: left;}</style>';
        ...
        var img=document.createElement("img");
        img.setAttribute("id","visi_image");
        img.src="https://img.visilabs.net/banner/uploaded_images/244_1240_20200611144057403.jpg";
        img.style.height="auto";
        img.style.width="100%";
        ...
        document.querySelector("#main-header").insertBefore(visi,document.querySelector(".pro-header-top"));
