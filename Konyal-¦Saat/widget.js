var vl = new Visilabs();
        ...
        function CallBackMethod(dataArr) {
            var bannerUnder = document.querySelector("#favCatWidget");
            var wrapper = document.createElement('div');
            wrapper.id = "topSellerWidget";
            ...
            widgetTitle.id = "topSellerTitle";
            widgetTitle.innerHTML = "<h2>ÇOK SATAN ÜRÜNLER</h2>";
