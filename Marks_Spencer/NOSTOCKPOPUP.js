function CallPopupMobile(targetUrl) {
    ...
    var innerWidth = window.innerWidth - 14;
    ...
    overlay_light.onclick = closeclick;
    ...
    img.src = "https://img.visilabs.net/banner/uploaded_images/92_1136_20200915083253367.jpg";
    ...
    cls_btn.style.top = "8px";
    cls_btn.style.right = "14px";
...
function showLightBoxDesktop(targetUrl) {
    ...
    var img = document.createElement("img");
    img.setAttribute("id", "visi_lightbox_image");
    img.src = "https://img.visilabs.net/banner/uploaded_images/92_1136_20200915083308522.jpg";
...
if (!document.querySelector("#visi_lightbox_content_fixed") && document.querySelector(".js-product-get-notice.product-get-notice__button.active")) {

    var a = document.querySelectorAll(".breadcrumb > a");
    a = a[a.length - 2].href;
    if (window.innerWidth < 600) {
        CallPopupMobile(a);
    }
    else {
        showLightBoxDesktop(a);
    }
