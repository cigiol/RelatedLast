function CallPopup() {
    ...
    link.href = "https://sachane.com/matrix-total-results/page-3/?utm_source=sacsirlari&utm_medium=uye_pop_up&utm_campaign=canlirenk";
    var img = document.createElement("img");
    img.setAttribute("id", "visi_lightbox_image");
    img.style.width = responsiveWidth;
    img.src = "https://img.visilabs.net/banner/uploaded_images/244_1244_20200703155222372.png";
...
var _interval = setInterval(function () {
    try {
        if(document.querySelector(".register-confirm").style.display=="block"){
            CallPopup();
