...
var stories = [{
        title: "Fırsat!",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200330185850970.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200330185806516.jpg",
        link: "https://www.englishhome.com/firsat-zamani/?OM.zn=acttype-4&OM.zpc=act-41&OM.story=75e-15",
        buttonText: "Fırsatları Kaçırma",
        buttonColor: "#544C39",
        buttonTextColor: "#ffffff",
        backgroundColor: "#544C39",
        seen: !1
    }, {
        title: "Nevresim Seti",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200330190122059.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200330190208733.jpg",
        ...
        title: "Havlu",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331102808643.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331102937029.jpg",
        link: "https://www.englishhome.com/banyo/havlu/?OM.zn=acttype-4&OM.zpc=act-41&OM.story=Havlu",
        ...
        title: "Yatak Örtüsü",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331103331194.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331103403706.jpg",
        link: "https://www.englishhome.com/yatak-odasi/yatak-ortusu/?OM.zn=acttype-4&OM.zpc=act-41&OM.story=Yatak-Ortusu",
        buttonText: "Şimdi Keşfet",
        buttonColor: "#9A5D41",
        buttonTextColor: "#fff",
        backgroundColor: "#9A5D41",
        ...
        title: "2'li Fırsat",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331104121400.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331104014496.jpg",
        link: "https://www.englishhome.com/yastik-yorgan-kampanya/?OM.zn=acttype-4&OM.zpc=act-41&OM.story=Yastik-alezi",
        buttonText: "Alışverişe Başla",
        buttonColor: "#9A5D41",
        buttonTextColor: "#fff",
        backgroundColor: "#9A5D41",
        ...
        title: "Salon",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331104745600.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331104903440.jpg",
        link: "https://www.englishhome.com/hali-kilim-indirim/?OM.zn=acttype-4&OM.zpc=act-41&OM.story=Hali-kilim",
        buttonText: "Şimdi Keşfet",
        buttonColor: "#9A5D41",
        buttonTextColor: "#fff",
        backgroundColor: "#9A5D41",
        ...
        title: "Düzenleme",
        smallImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331105359530.jpg",
        largeImg: "https://img.visilabs.net/banner/uploaded_images/79_726_20200331105329223.jpg",
        link: "https://www.englishhome.com/ev-gerecleri/hurc/?OM.zn=acttype-4&OM.zpc=act-41&OM.story=Hurc",
        buttonText: "Alışverişe Başla",
        buttonColor: "#9A5D41",
        buttonTextColor: "#fff",
        backgroundColor: "#9A5D41",
...
function storyInit() {
    ...
    var m = document.querySelector("body > div.js-main-wrapper > div.container > div.visible-xs");
    m.insertBefore(p,m.querySelector(".main-slider-wrapper.js-analytics-banner")),
        function () {
...
var storyTitle=document.querySelectorAll(".vl-story-title");for(let t=0;t<storyTitle.length;t++)"YE-İÇ"===storyTitle[t].innerText?storyTitle[t].style.color="#a1237d":"CİGNA FİNANS"===storyTitle[t].innerText?storyTitle[t].style.color="#004b9f":"YAŞA"===storyTitle[t].innerText?storyTitle[t].style.color="#44abe0":"SEV"===storyTitle[t].innerText?storyTitle[t].style.color="#53af47":"TEST"===storyTitle[t].innerText?storyTitle[t].style.color="#df5151":"ASTROLOJİ"===storyTitle[t].innerText?storyTitle[t].style.color="#2a2f7a":"HAREKET ET"===storyTitle[t].innerText&&(storyTitle[t].style.color="#e87d2a"),storyTitle[t].style.fontWeight="600",storyTitle[t].style.textShadow="none";
...
noStoryTitle.setAttribute("class","vl-story-mini-title");
noStoryTitle.innerText="Ayın Yıldızları";

var noStoryInner=document.createElement("div");
noStoryInner.setAttribute("class","vl-story-mini-inner");
noStoryInner.style.backgroundImage="url(https://img.visilabs.net/banner/uploaded_images/79_726_20200331145523095.png)"

noStoryOuter.append(noStoryInner);
divToLink.append(noStoryOuter);
divToLink.append(noStoryTitle);

document.querySelector("#vl-story-mini-wrapper").insertBefore(divToLink,document.querySelector("#vl-story-mini-1"));
