if(window.innerWidth>500){
    ...
    div.innerHTML="Siparişlerinizi en hızlı şekilde ulaştırmak için yoğun bir şekilde çalışıyoruz.<br/>\
    Ancak içinde bulunduğumuz Covid-19 salgını sebebiyle aldığımız önlemler ve yoğunluktan dolayı siparişlerin kargoya teslim süreleri 5 iş gününü bulmaktadır.<br/>\
    Siparişleriniz kargoya verildikten sonra teslim süreleri, kargolarda oluşabilecek yoğunluklara göre değişebilir.";
    document.querySelector(".body-home.gap").append(div);
