(function(){
    ...
    var campID = 93;
    var img = "https://img.visilabs.net/banner/uploaded_images/92_729_20200422144421424.jpg";
    var img_mob= 'https://img.visilabs.net/banner/uploaded_images/92_729_20200422144434075.jpg';
    function init(){
       var style = '<style>\
          ...
          #vl-close{opacity: 0;position: absolute;height: 25px; width: 25px; right: 8px;top: 9px; font-size: 24px; cursor: pointer;z-index: 9999999999;text-align: center; border-radius: 50px; line-height: 23px;}\
          #vl-button{width: 238px;height: 40px;position: absolute;bottom: 30px;right: 116px;}\
          #assistantCodeArea{width: 240px;text-align: center;padding: 4px;position: absolute;bottom: 130px;right: 78px;}\
          #assistantCodeArea input{width: 240px;background-color: #122148;border: none;color: #009fdc;font-weight: bold;font-size: 25px;}\
            #assistantCopyButton{width: 280px;cursor: pointer;position: absolute;bottom: 94px;right: 95px;height: 35px;}\
       ...
       var html = '<div id="vl-overlay"/><div id="vl-container"><div id="vl-close"></div><div id="assistantCodeArea"><input type="text" value="'+coupon+'" id="couponCode" readonly/></div>\
                <div id="assistantCopyButton"></div><a href="https://gap.com.tr/gap-sezon-urunleri/?OM.zn=acttype-4&OM.zpc=act-93" id="vl-button"></a></div>';
