function showSideBarDesktop(){
    ...
    img.src="https://img.visilabs.net/banner/uploaded_images/152_1205_20200424100550813.jpg";
...
function showLightBoxDesktop(height,width){
    ...
    link.href="https://www.nautica-tr.com/20-ss-sezon-ortasi/?OM.zn=acttype-4&OM.zpc=act-45";
    ...
    img.src="https://img.visilabs.net/banner/uploaded_images/152_1205_20200424100658153.jpg";
...
function showLightBoxMobile(height,width){
    ...
    var img=document.createElement("img");
    img.setAttribute("id","visi_lightbox_image");
    img.src="https://img.visilabs.net/banner/uploaded_images/152_1205_20200424100624465.jpg";
