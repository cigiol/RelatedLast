...
var storyTitle=document.querySelectorAll(".vl-story-title");for(let t=0;t<storyTitle.length;t++)"FERDİ KAZA"===storyTitle[t].innerText?storyTitle[t].style.color="white":"HAYAT"===storyTitle[t].innerText?storyTitle[t].style.color="white":"BES"===storyTitle[t].innerText?storyTitle[t].style.color="white":"İYİ HİSSET"===storyTitle[t].innerText?storyTitle[t].style.color="#a3227e":"S.S.S."===storyTitle[t].innerText&&(storyTitle[t].style.color="white"),storyTitle[t].style.fontWeight="600",storyTitle[t].style.textShadow="none";