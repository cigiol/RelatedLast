...
if (/windows phone/i.test(userAgent)) {
    link.href="https://play.google.com/store/apps/details?id=com.akinon.occasion";
    link.width="100%";
    link.height="100%";
}
   ...
   link.height="100%";
    ...
    link.href="https://apps.apple.com/tr/app/occasion/id1469200319?l=tr";
    link.width="100%";
    link.height="100%";
}
else{
...
img.src="https://img.visilabs.net/banner/uploaded_images/152_1083_20200430141137099.jpg";
...
document.querySelector(".page-header.hide-on-app").insertBefore(visi,document.querySelector(".menu-area"));
