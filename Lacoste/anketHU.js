function showLightBoxDesktop(height, width) {
    ...
    img.src = "https://img.visilabs.net/banner/uploaded_images/152_1237_20200529090804904.jpg";
    img.style.width = "100%";
...
var values = {"choice1":"Már teljesítettem a látogatási célomat", "choice2":"Több időre van szükségem a gondolkodáshoz","choice3":"Össze szeretném hasonlítani az árakat más üzletekben", "choice4":"Nem találom a terméket","choice5":"Túl kevés termékinformáció", "choice6":"Túl magas ár"};
    ...
    submitButton.addEventListener("click", function () {
        ...
        var vl = new Visilabs();
        vl.AddParameter("OM.surveyLacosteHU", selectedValue);
        vl.Collect();
        closeclick();
    });
