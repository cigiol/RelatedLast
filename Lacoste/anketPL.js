function showLightBoxDesktop(height, width) {
    ...
    img.src = "https://img.visilabs.net/banner/uploaded_images/152_1211_20200528163329358.jpg";
    img.style.width = "100%";
...
var values = {"choice1":"Zrealizowałem/am już swój cel wizyty", "choice2":"Potrzebuję więcej czasu na namysł","choice3":"Chcę porównać cenę w innych sklepach", "choice4":"Nie mogę znaleźć produktu","choice5":"Zbyt mało informacji o produkcie", "choice6":"Zbyt wysoka cena"};
    ...
    submitButton.addEventListener("click", function () {
        ...
        var vl = new Visilabs();
        vl.AddParameter("OM.surveyLacostePL", selectedValue);
        vl.Collect();
        closeclick();
    });
