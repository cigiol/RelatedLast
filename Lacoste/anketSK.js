function showLightBoxDesktop(height, width) {
    ...
    img.src = "https://img.visilabs.net/banner/uploaded_images/152_1251_20200529091214053.jpg";
    img.style.width = "100%";
...
var values = {"choice1":"I have already completed my purpose of visit", "choice2":"I need more time to think","choice3":"I want to compare the price in other stores", "choice4":"I can't find the product","choice5":"Too little product information", "choice6":"Too high price"};
    ...
    submitButton.addEventListener("click", function () {
        ...
        var vl = new Visilabs();
        vl.AddParameter("OM.surveyLacosteSK", selectedValue);
        vl.Collect();
        closeclick();
    });
