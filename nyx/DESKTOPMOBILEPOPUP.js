function CallPopupDesktop() {
    var innerWidth = window.innerWidth;
    var responsiveWidth = innerWidth/2 + 'px';
   ...
   overlay_content.style.transform="translate(-50%,50%)";
    ...
    link.href = "https://www.nyxcosmetics.com.tr/hello-nyx-nyx-professional-makeup-tanisma-seti";
    var img = document.createElement("img");
    img.setAttribute("id", "visi_lightbox_image");
    img.style.width = responsiveWidth;
    img.src = "https://img.visilabs.net/banner/uploaded_images/244_1239_20200714170916400.png";
